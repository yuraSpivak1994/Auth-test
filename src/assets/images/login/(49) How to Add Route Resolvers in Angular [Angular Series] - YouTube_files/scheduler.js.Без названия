...
x.prototype.o=function(){if(this.m)for(;this.m.length;)this.m.shift()()};/*
...
*/
var y=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};w("yt.config_",y);function A(a,b){return a in y?y[a]:b}
...
this.A)}
F.prototype=f(x.prototype);F.prototype.constructor=F;if(m)m(F,x);else for(var G in x)if("prototype"!=G)if(Object.defineProperties){var H=Object.getOwnPropertyDescriptor(x,G);H&&Object.defineProperty(F,G,H)}else F[G]=x[G];function I(a,b){var c=v();J(b);c=v()-c;a.i||(a.l-=c)}
